...
const CustomLeftArrow: React.FC<ArrowProps> = ({ onClick }) => {
  return (
    <button
      onClick={onClick}
      className="  left-0 sm:left-20 top-1/2 transform -translate-y-1/2 z-10 bg-white p-2 rounded-lg border shadow-sm focus:outline-none 0"
...
const CustomRightArrow: React.FC<ArrowProps> = ({ onClick }) => {
  return (
    <button
      onClick={onClick}
      className=" right-0 sm:right-20 top-1/2 transform -translate-y-1/2 z-10 bg-white p-2 rounded-lg border shadow-sm focus:outline-none"
